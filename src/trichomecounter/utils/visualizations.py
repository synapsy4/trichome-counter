...
from trichomecounter.model.evaluations import predict_single_image
from trichomecounter.paths import OUTPUTS_DIR
...
def visualize_test_samples(model: torch.nn.Module,
    ...
    if save_fig:
        save_path = OUTPUTS_DIR / cfg["model"]["model_name"]
